      ...
      {Object.keys(product).length > 0 ? <><section className="product-single container product-single__type-9">
        <div className="row">
          ...
          <div className="col-lg-5">
            <div className="d-none d-md-flex justify-content-between mb-4 pb-md-2">
            ...
            <div className="product-single__addtolinks">
              <ShareComponent title={locale === "ar" ? (product?.product_name_ar || t(he.decode(product?.product_name || ""))) : (product?.product_name || "")} />
            </div>
